...
def getRandomWord():
    words = ['pikachu', 'charizard', 'onix', 'bulbasaur', 'eevee', 'gengar', 'lapras', 'gyarados',
             'dragonite', 'arcanine', 'magmar', 'vulpix', 'psyduck', 'togepi', 'squirtle', 'totodile', 'pidgeot']
...
def playAgain():
    return input("\nDo you want to play again? press y to play again ").lower().startswith('y')
